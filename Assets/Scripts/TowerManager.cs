        ...
        if(isPlacing)
        {
            ...
            */
            ...
            else
            {
                ...
                UIConroller.instance.notEnoughMoneyWarning.SetActive(MoneyManager.instance.currentMoney < activeTower.cost);
                ...
                if (Input.GetMouseButtonDown(0))
                {
                    if (MoneyManager.instance.SpendMoney(activeTower.cost))
                    {
                        ...
                        UIConroller.instance.notEnoughMoneyWarning.SetActive(false);
